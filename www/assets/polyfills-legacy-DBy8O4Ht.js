(function () {
	...
	var fails$14 = fails$18;
	var globalThis$_ = globalThis_1;

	var $String$6 = globalThis$_.String;

	// eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	var symbolConstructorDetection = !!Object.getOwnPropertySymbols && !fails$14(function () {
	...
	var ordinaryToPrimitive$2 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$v(val = call$E(fn, input))) return val;
	  if (isCallable$r(fn = input.valueOf) && !isObject$v(val = call$E(fn, input))) return val;
	  if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$v(val = call$E(fn, input))) return val;
	...
	var EXISTS$1 = isObject$t(document$3) && isObject$t(document$3.createElement);
	...
	var ie8DomDefine = !DESCRIPTORS$G && !fails$13(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var fails$12 = fails$18;

	// V8 ~ Chrome 36-
	// https://bugs.chromium.org/p/v8/issues/detail?id=3334
	var v8PrototypeDefineBug = DESCRIPTORS$E && fails$12(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var CONFIGURABLE_LENGTH = DESCRIPTORS$A && !fails$11(function () {
	...
	var isForced$5 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$m(detection) ? fails$10(detection)
	    : !!detection;
	};
	...
	*/
	...
	var isConstructor$4 = !construct$1 || fails$$(function () {
	  var called;
	...
	var setSymbolDescriptor = DESCRIPTORS$y && fails$_(function () {
	...
	$$1J({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$y }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	var FORCED$j = !NATIVE_SYMBOL$2 || fails$Y(function () { getOwnPropertySymbolsModule$1.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	$$1F({ target: 'Object', stat: true, forced: FORCED$j }, {
	...
	var isPossiblePrototype$1 = function (argument) {
	  return isObject$p(argument) || argument === null;
	};
	...
	var installErrorCause$1 = function (O, options) {
	  if (isObject$m(options) && 'cause' in options) {
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1D({ global: true, constructor: true, arity: 1, forced: FORCED$i }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1D({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$i }, O);
	  }
	};
	...
	$$1B({ target: 'Array', proto: true, arity: 1, forced: FORCED$h }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$1y({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
	...
	// `Array.prototype.find` method
	// https://tc39.es/ecma262/#sec-array.prototype.find
	$$1x({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
	...
	// `Array.prototype.findIndex` method
	// https://tc39.es/ecma262/#sec-array.prototype.findindex
	$$1w({ target: 'Array', proto: true, forced: SKIPS_HOLES }, {
	...
	// `Array.from` method
	// https://tc39.es/ecma262/#sec-array.from
	$$1t({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
	  from: from
	});
	...
	// FF99+ bug
	var BROKEN_ON_SPARSE = fails$U(function () {
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$1s({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$k(IteratorPrototype$4) || fails$S(function () {
	  var test = {};
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$1r({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	$$1q({ target: 'Array', proto: true, forced: FORCED$g }, {
	...
	// https://tc39.es/ecma262/#sec-array.prototype.map
	// with adding support of @@species
	$$1p({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 }, {
	...
	$$1o({ target: 'Array', proto: true, arity: 1, forced: FORCED$f }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$1n({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	...
	$$1m({ target: 'Array', proto: true, forced: FORCED$e }, {
	...
	// with adding support of @@species
	$$1l({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	...
	$$1k({ target: 'Array', proto: true, arity: 1, forced: FORCED$d }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$1j({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$6 }, {
	...
	if ($transfer$1) $$1i({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$1h({ target: 'ArrayBuffer', proto: true }, {
	...
	$$1g({ global: true, forced: globalThis$F.globalThis !== globalThis$F }, {
	...
	var FAILS_ON_PRIMITIVES$6 = fails$L(function () { $isExtensible(1); });
	...
	var enable = function () {
	  ...
	  if (getOwnPropertyNames(test).length) {
	    ...
	    $$1f({ target: 'Object', stat: true, forced: true }, {
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var fixMethod = function (KEY) {
	    ...
	    defineBuiltIn$c(NativePrototype, KEY,
	      KEY === 'add' ? function add(value) {
	        ...
	        return IS_WEAK && !isObject$g(key) ? false : uncurriedNativeMethod(this, key === 0 ? 0 : key);
	      } : KEY === 'get' ? function get(key) {
	        return IS_WEAK && !isObject$g(key) ? undefined : uncurriedNativeMethod(this, key === 0 ? 0 : key);
	  ...
	  var REPLACE = isForced$3(
	    CONSTRUCTOR_NAME,
	    !isCallable$c(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$J(function () {
	  ...
	  $$1e({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
	...
	$$1b({ target: 'Math', stat: true, arity: 2, forced: FORCED$c }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$1a({ target: 'Math', stat: true, forced: FORCED$b }, {
	...
	var calledWithNew = function (dummy) {
	  ...
	  return isPrototypeOf$5(NumberPrototype, dummy) && fails$H(function () { thisNumberValue(dummy); });
	};
	...
	$$17({ global: true, constructor: true, wrap: true, forced: FORCED$a }, {
	...
	$$16({ target: 'Number', stat: true, nonConfigurable: true, nonWritable: true }, {
	...
	$$13({ target: 'Number', stat: true, nonConfigurable: true, nonWritable: true }, {
	...
	$$12({ target: 'Object', stat: true, arity: 2, forced: Object.assign !== assign$1 }, {
	  assign: assign$1
	});
	...
	var IE_BUG = DESCRIPTORS$l && fails$F(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	var FAILS_ON_PRIMITIVES$5 = fails$E(function () { $freeze(1); });

	// `Object.freeze` method
	// https://tc39.es/ecma262/#sec-object.freeze
	$$10({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$5, sham: !FREEZING$3 }, {
	  freeze: function freeze(it) {
	    return $freeze && isObject$f(it) ? $freeze(onFreeze$2(it)) : it;
	  }
	});
	...
	var FORCED$9 = !DESCRIPTORS$k || fails$D(function () { nativeGetOwnPropertyDescriptor$1(1); });

	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$$({ target: 'Object', stat: true, forced: FORCED$9, sham: !DESCRIPTORS$k }, {
	...
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
	$$_({ target: 'Object', stat: true, sham: !DESCRIPTORS$j }, {
	...
	var FAILS_ON_PRIMITIVES$4 = fails$C(function () { return !Object.getOwnPropertyNames(1); });

	// `Object.getOwnPropertyNames` method
	// https://tc39.es/ecma262/#sec-object.getownpropertynames
	$$Z({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$4 }, {
	...
	var FAILS_ON_PRIMITIVES$3 = fails$B(function () { nativeGetPrototypeOf(1); });

	// `Object.getPrototypeOf` method
	// https://tc39.es/ecma262/#sec-object.getprototypeof
	$$Y({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !CORRECT_PROTOTYPE_GETTER }, {
	...
	if (DESCRIPTORS$i) {
	  $$V({ target: 'Object', proto: true, forced: FORCED$8 }, {
	...
	$$U({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$1, sham: !FREEZING$2 }, {
	...
	$$T({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !FREEZING$1 }, {
	...
	$$k({ global: true, constructor: true, forced: FORCED$1 }, {
	...
	$$i({ target: 'Iterator', proto: true, real: true, forced: IS_PURE$2 }, {
	...
	$$c({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate(getIteratorDirect(anObject$3(this)), push$5, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	$$b({ target: 'JSON', stat: true, forced: NO_SOURCE_SUPPORT }, {
	...
	var exec$3 = uncurryThis$7(disallowed.exec);
	...
	$$a({ global: true, bind: true, enumerable: true, forced: FORCED }, {
	...
	$$9({ global: true, bind: true, enumerable: true, forced: !BASIC || NO_ARG_RECEIVING_CHECK || WRONG_ARG_CONVERSION || WRONG_ARITY$1 }, {
