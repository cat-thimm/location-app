import { n as createAnimation, o as getIonPageElement } from "./index-QkXJ8ysh.js";
/*!
...
const animateBackButton = (rootAnimation, rtl, backDirection, backButtonEl, backButtonBox, backButtonTextEl, backButtonTextBox, largeTitleEl, largeTitleTextBox) => {
  ...
  let WIDTH_SCALE = 1;
  let HEIGHT_SCALE = 1;
  let TEXT_START_SCALE = "scale(".concat(HEIGHT_SCALE, ")");
  ...
  const CONTAINER_START_TRANSLATE_X = rtl ? "".concat(backButtonIconBox.width / 2 - (backButtonIconBox.right - backButtonBox.right), "px") : "".concat(backButtonBox.left - backButtonIconBox.width / 2, "px");
  const CONTAINER_END_TRANSLATE_X = rtl ? "-".concat(window.innerWidth - backButtonBox.right, "px") : "".concat(backButtonBox.left, "px");
  const CONTAINER_START_TRANSLATE_Y = "".concat(largeTitleTextBox.top, "px");
  const CONTAINER_END_TRANSLATE_Y = "".concat(backButtonBox.top, "px");
  const FORWARD_CONTAINER_KEYFRAMES = [
    { offset: 0, transform: "translate3d(".concat(CONTAINER_START_TRANSLATE_X, ", ").concat(CONTAINER_START_TRANSLATE_Y, ", 0)") },
    { offset: 1, transform: "translate3d(".concat(CONTAINER_END_TRANSLATE_X, ", ").concat(CONTAINER_END_TRANSLATE_Y, ", 0)") }
  ];
  const BACKWARD_CONTAINER_KEYFRAMES = [
    { offset: 0, transform: "translate3d(".concat(CONTAINER_END_TRANSLATE_X, ", ").concat(CONTAINER_END_TRANSLATE_Y, ", 0)") },
    { offset: 1, transform: "translate3d(".concat(CONTAINER_START_TRANSLATE_X, ", ").concat(CONTAINER_START_TRANSLATE_Y, ", 0)") }
  ];
...
const animateLargeTitle = (rootAnimation, rtl, backDirection, largeTitleEl, largeTitleBox, largeTitleTextBox, backButtonBox, backButtonTextEl, backButtonTextBox) => {
  ...
  const START_TRANSLATE_Y = "".concat(largeTitleBox.top, "px");
  const LARGE_TITLE_TRANSLATION_OFFSET = 8;
  let END_TRANSLATE_X = rtl ? "-".concat(window.innerWidth - backButtonBox.right - LARGE_TITLE_TRANSLATION_OFFSET, "px") : "".concat(backButtonBox.x + LARGE_TITLE_TRANSLATION_OFFSET, "px");
  let HEIGHT_SCALE = 0.5;
  const START_SCALE = "scale(1)";
  let END_SCALE = "scale(".concat(HEIGHT_SCALE, ")");
  if (backButtonTextEl && backButtonTextBox) {
  ...
  const END_TRANSLATE_Y = "".concat(backButtonMidPoint - titleMidPoint, "px");
  const BACKWARDS_KEYFRAMES = [
    { offset: 0, opacity: 0, transform: "translate3d(".concat(END_TRANSLATE_X, ", ").concat(END_TRANSLATE_Y, ", 0) ").concat(END_SCALE) },
    { offset: 0.1, opacity: 0 },
    { offset: 1, opacity: 1, transform: "translate3d(".concat(START_TRANSLATE_X, ", ").concat(START_TRANSLATE_Y, ", 0) ").concat(START_SCALE) }
  ];
  const FORWARDS_KEYFRAMES = [
    ...
    { offset: 1, opacity: 0, transform: "translate3d(".concat(END_TRANSLATE_X, ", ").concat(END_TRANSLATE_Y, ", 0) ").concat(END_SCALE) }
  ];
